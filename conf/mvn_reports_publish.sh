...
rm -rf out/maven/* || exit 0

# Copy the code quality reports generated by Maven to out/maven/
cp -r target/site/* out/maven/
...
git add .
git commit -m "[Travis Commit] Automated Deploy to gh-pages/maven | Caused by ${SHA}
refer auto_commit_script: https://github.com/prasadtalasila/BITS-Darshini/blob/$SOURCE_BRANCH/conf/mvn_reports_publish.sh
"
